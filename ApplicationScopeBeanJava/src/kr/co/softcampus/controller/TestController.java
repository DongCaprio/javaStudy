...
public class TestController {
	...
	//DataBean3부터는 Bean위에 @Component붙히고
    //ServletAppContext에 @ComponentScan으로 패키지명 추가하고사용함
	...
	public String result1(Model model) {
		//applicationScoep는 바로 출력이 가능하다(다른 브라우져에서도 가능)
		//but applicationScope영역에 저장이 되는것은 아니다!!!!!그러므로 출력하려면 model등을 사용해야 출력이 가능하다
